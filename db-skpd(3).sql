...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2018 at 03:56 AM
...
-- Database: `db-skpd`
--
CREATE DATABASE IF NOT EXISTS `db-skpd` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db-skpd`;
...
--
-- Creation: May 19, 2018 at 03:38 AM
--
...
--
-- Truncate table before insert `aturan`
--

TRUNCATE TABLE `aturan`;
--
...
--
-- Creation: May 18, 2018 at 02:11 AM
--
...
--
-- Creation: May 19, 2018 at 04:41 AM
--

DROP TABLE IF EXISTS `barang_optimasi`;
...
--
-- RELATIONS FOR TABLE `barang_optimasi`:
--   `kode_jabatan`
--       `jabatan` -> `kode_jabatan`
--   `kode_skpd`
--       `skpd` -> `id_skpd`
...
--
-- Truncate table before insert `barang_optimasi`
--

TRUNCATE TABLE `barang_optimasi`;
-- --------------------------------------------------------

--
-- Table structure for table `jabatan`
--
-- Creation: May 18, 2018 at 06:51 AM
--
...
DROP TABLE IF EXISTS `kegiatan_program`;
...
--
-- RELATIONS FOR TABLE `kegiatan_program`:
--   `id_program`
--       `program_skpd` -> `id_program`
--

--
-- Truncate table before insert `kegiatan_program`
--

TRUNCATE TABLE `kegiatan_program`;
--
...
--
-- Creation: May 19, 2018 at 04:12 AM
--
...
DROP TABLE IF EXISTS `max_barang`;
...
--
-- RELATIONS FOR TABLE `max_barang`:
--   `id_perencanaan_kebutuhan`
--       `perencanaan_kebutuhan` -> `id_perencanaan_kebutuhan`
--   `kode_barang`
--       `barang` -> `kode_barang`
--

--
-- Truncate table before insert `max_barang`
--

TRUNCATE TABLE `max_barang`;
--
...
DROP TABLE IF EXISTS `perencanaan_kebutuhan`;
...
--
-- RELATIONS FOR TABLE `perencanaan_kebutuhan`:
--   `id_skpd`
--       `skpd` -> `id_skpd`
--

--
-- Truncate table before insert `perencanaan_kebutuhan`
--

TRUNCATE TABLE `perencanaan_kebutuhan`;
--
...
--
-- Creation: May 19, 2018 at 04:13 AM
--
...
--
-- RELATIONS FOR TABLE `pns`:
--   `id_skpd`
--       `skpd` -> `id_skpd`
--

--
-- Truncate table before insert `pns`
--
...
--
-- Creation: May 19, 2018 at 05:14 AM
--

DROP TABLE IF EXISTS `program_skpd`;
...
--
-- RELATIONS FOR TABLE `program_skpd`:
--   `id_skpd`
--       `skpd` -> `id_skpd`
--

--
-- Truncate table before insert `program_skpd`
--

TRUNCATE TABLE `program_skpd`;
--
...
--
-- Creation: May 18, 2018 at 07:00 AM
--
...
--
-- RELATIONS FOR TABLE `skpd`:
--

--
-- Truncate table before insert `skpd`
--
...
--
-- Creation: May 19, 2018 at 03:58 AM
--
...
--
-- RELATIONS FOR TABLE `usulan_barang`:
--   `id_kegiatan`
--       `kegiatan_program` -> `id_kegiatan`
--   `kode_barang`
--       `barang` -> `kode_barang`
--   `kode_jabatan`
--       `jabatan` -> `kode_jabatan`
...
--
-- Truncate table before insert `usulan_barang`
--

TRUNCATE TABLE `usulan_barang`;
--
