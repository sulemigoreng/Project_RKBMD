	...
	<div>
		...
		<div class="about">
			<div class="about-content">
				<div class="about-img">
					<img src="assets/img/logo2.png" height="100%" style="float:left">
				</div>
				<div class="about-text">
					<h2 style="">RKBMD Kendaraan Dinas dan Peralatan Kantor V.1.1</h2>
					...
					<div style="width:100%;height:112px;">
						...
						<div class="about-contact">
							...
							<small>
								Jl. Raden Demang Hadjarkusumah Komplek Perkantoran Pemerintah Kota Cimahi<br/>
								Telepon (022) 6654274<br/>
